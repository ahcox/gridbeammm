...
result += build_grid_beam_only_vertical(default_beam_args, 38,1, 1).translate([0, base + post(step), 0])
result += build_grid_beam_only_vertical(default_beam_args, 30,1, 1).translate([0, base + post(step), 0])
result += build_grid_beam_only_vertical(default_beam_args, 30,1, 1).translate([0, base + post(step), 0])
result += build_grid_beam_only_vertical(default_beam_args, 28,1, 1).translate([0, base + post(step), 0])
result += build_grid_beam_only_vertical(default_beam_args, 28,1, 1).translate([0, base + post(step), 0])
result += build_grid_beam_only_vertical(default_beam_args, 20,1, 1).translate([0, base + post(step), 0])
result += build_grid_beam_only_vertical(default_beam_args, 20,1, 1).translate([0, base + post(step), 0])
result += build_grid_beam_only_vertical(default_beam_args, 18,1, 1).translate([0, base + post(step), 0])
result += build_grid_beam_only_vertical(default_beam_args, 18,1, 1).translate([0, base + post(step), 0])
post(step)
post(step)
