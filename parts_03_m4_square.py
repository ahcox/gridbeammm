...
filename_base = "gridbeam_parts_03_m4_square_"
...
def build_beam(x, y, z):
    # build_grid_beam_capped_x_square_y
    result  = build_grid_beam_capped_x_square_y(beam_args, x, y, z)
    result = result.clean()
